...
if (isset($_GET['ajax'])) {
    ...
    $html_tabla = generarFilasPendientes($con, $nit_farmacia_actual, $pagina_actual_ajax, $total_paginas_ajax, $total_registros_ajax);
    echo json_encode(['html_tabla' => $html_tabla, 'total_paginas' => $total_paginas_ajax, 'pagina_actual' => $pagina_actual_ajax, 'total_registros' => $total_registros_ajax]);
    exit;
}
...
$total_paginas = 1;
$total_registros = 0;
$filas_pendientes_html = generarFilasPendientes($con, $nit_farmacia_actual, $pagina_actual, $total_paginas, $total_registros);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <main id="contenido-principal" class="flex-grow-1 d-flex flex-column">
        <div class="container-fluid mt-3 flex-grow-1 d-flex flex-column">
            <div class="vista-datos-container">
                ...
                <div class="table-responsive"><table class="tabla-admin-mejorada"><thead><tr><th>Radicado</th><th>Paciente</th><th>Medicamento</th><th class="text-center">Cantidad</th><th>Fecha Generación</th><th class="columna-acciones-fija">Acciones</th></tr></thead><tbody id="tabla-pendientes-body"><?php echo $filas_pendientes_html; ?></tbody></table></div>
