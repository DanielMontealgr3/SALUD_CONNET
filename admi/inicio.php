        ...
        <div class="container mt-5 pt-5"> 
            <div class="contenedor-bienvenida text-center">
                <h1 class="mensaje-bienvenida display-5 mb-4">
                    Bienvenido Administrador/a, <strong><?php echo htmlspecialchars($nombre_usuario); ?></strong>
                </h1>
                <div class="contenedor-imagen-admin">
                    <img src="../img/bodyadmi.webp" alt="Imagen de Administrador" class="imagen-admin img-fluid rounded" style="max-width: 500px; height: auto;"> 
                </div>
            </div>
        </div>
    </main>
