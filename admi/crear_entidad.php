        ...
        try {
            ...
            if ($tipo_entidad === 'farmacia') {
                ...
                if(!empty($tipo_entidad)) {
                    $errores_validacion[] = "Tipo de entidad no válido.";
                } elseif(empty($tipo_entidad) && isset($_POST['guardar_entidad'])) {
                     $errores_validacion[] = "Debe seleccionar un tipo de entidad.";
                }
            }
            ...
            if ($con->inTransaction()) { $con->rollBack(); }
            $mensaje_error_pdo = "Error PDO al guardar entidad: " . htmlspecialchars($e->getMessage());
            if ($e->getCode() == '23000' || $e->getCode() == 1062) { 
                 $mensaje_error_pdo = "Error: Ya existe una entidad con el NIT proporcionado o algún otro identificador único.";
            }
