                ...
                <div class="col">
                    <div class="card opcion_cita text-center h-100">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a href="cita_examen.php" class="btn btn-primary mt-2">Ingresar</a>
                        </div>
                    </div>
                </div>

                <!-- Turno Medicamentos (AHORA APUNTA A PENDIENTES.PHP) -->
                <div class="col">
                    <div class="card opcion_cita text-center h-100">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a href="pendientes.php" class="btn btn-primary mt-2">Ingresar</a>
                        </div>
                    </div>
                </div>
            </div>
